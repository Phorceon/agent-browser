...
/**
 * Portable delay helper. `page.waitForTimeout` was deprecated in
 * puppeteer-core v19; this works across all versions.
 */
function delay(ms) {
...
async function launchBrowser() {
  ...
  if (!video) {
    throw new Error(`No video matching selector found: ${videoSelector}`);
  }
