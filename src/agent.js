...
export class Agent {
  ...
  /**
   * Execute a list of tool calls, pushing results into this.messages.
   * Handles screenshots, error warnings, and abort checks.
   */
  ...
  async run(userMessage) {
    ...
    // If we exit the loop without returning, summarize
    if (steps >= MAX_STEPS) {
